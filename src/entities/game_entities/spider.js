...
export class Spider extends Entity{
    ...
    constructor(game, map, worldX, worldY){
        super(game, map, game.tilesets["spider_tileset"],
			new Hitbox(game, map, 0, 0, constants.TILE_SIZE * 2, constants.TILE_SIZE * 2.5, true, false),
			new Hitbox(game, map, 0, 0, constants.TILE_SIZE * 2, constants.TILE_SIZE * 2.5, false, false),
