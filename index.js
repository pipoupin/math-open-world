...
function update() {
	...
	if (0 <= newWorldX && newWorldX <= WORLD_WIDTH - TILE_SIZE) { // Adjusting the X border by replacing player.hitbox.width by TILE_SIZE.
	...
	if (0 <= newWorldY && newWorldY <= WORLD_HEIGHT - TILE_SIZE) { // Doing the same for the Y border.
